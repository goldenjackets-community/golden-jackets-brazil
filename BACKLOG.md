...
- [x] Site goldenjacketsbrazil.com live
- [x] GitHub org migration (goldenjackets-community)
- [x] CI/CD pipeline (GitHub Actions → S3 → CloudFront → smoke test)
- [x] Members Lounge with Cognito auth
- [x] Admin panel with chapter isolation (Cognito Groups)
- [x] Co-Founders (Erick, Wagner) added as admins
- [x] Apply form creates PR with HTML card automatically
- [x] Translations PT complete (ticker, about, FAQ, events, sponsors)
- [x] Backup vault (gj-site-backups, daily, 7-day retention)
- [x] CloudFront origin fixed (www bucket)
- [x] Co-Founder Operations Guide (PDF in admin)
