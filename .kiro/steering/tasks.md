...
3. Fill in: name, city, state code (2 letters), certification date, LinkedIn URL
4. Insert before the corresponding `<!-- END_* -->` comment
5. Do NOT manually set `card-number` — CI/CD auto-numbers on deploy
6. Update map pins if new state is represented
...
4. Change certified line to actual date
...
- [ ] Translations object updated if new user-facing text added
